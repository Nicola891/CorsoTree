 ...
 * Il distributore gestirà una lista di 2 tipi diversi di prodotti: Caffè e Cappuccino.
 Progettare la classe DistributoreDiBevande costruito con un intero n che
 determina il numero di prodotti nel distributore
...
public class TestMain {
    public static void main(String[] args) {
        DistributoreDiBevande d = new DistributoreDiBevande(10);
        Prodotto cappuccino = new Cappuccino();
        Prodotto caffe = new Caffe();
        d.scegliProdotto(caffe.getCodiceUnivoco());
        d.scegliProdotto(cappuccino.getCodiceUnivoco());
        //DistributoreDiBevande d = new DistributoreDiBevande(new Prodotto[4], 5);

        d.caricaProdotto(caffe);
        d.caricaProdotto(caffe);
        d.caricaProdotto(cappuccino);
        d.caricaProdotto(caffe);
        d.caricaProdotto(caffe);
        d.caricaProdotto(cappuccino);
        d.caricaProdotto(caffe);
        System.out.println(d.saldoAttuale() == 0);
        System.out.println(d.resto() == 0);
        d.inserisciImporto(0.4);
        System.out.println(d.scegliProdotto(01) == null);
        d.inserisciImporto(0.2);
        System.out.println(d.scegliProdotto(01) != null);
        System.out.println(d.resto()-0.10 < 1E-6);
        System.out.println(d.saldoAttuale() == 0);
        System.out.println(d.scegliProdotto(01) == null);
        d.inserisciImporto(2.0);
        System.out.println(d.scegliProdotto(01) != null);
        System.out.println(d.scegliProdotto(02) != null);
        System.out.println(d.scegliProdotto(01) != null);
        System.out.println(d.saldoAttuale() == 0);
        System.out.println(d.resto()-0.10 < 1E-6);
